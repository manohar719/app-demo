...
import { stocksInPortfolio, uncategorizedStocks, heatmapStocks } from '../data/stock';
import { Stock } from '../models/stock';
import { StockIntervalDetails } from '../models/stock-interval-details';
...
export class StockDataService {
    ...
    private generateDataForSymbol(stock: Stock, intervalInMinutes: number, range: any): StockIntervalDetails[] {
